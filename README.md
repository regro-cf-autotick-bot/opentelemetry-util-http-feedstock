...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/opentelemetry-util-http-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13870&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/opentelemetry-util-http-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `opentelemetry-util-http` can be installed with:

```
conda install opentelemetry-util-http
```

It is possible to list all of the versions of `opentelemetry-util-http` available on your platform with:
